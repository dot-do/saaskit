...
export type Verb = string & {
    readonly __brand: 'Verb';
};
/**
 * Type guard to check if a string is a valid camelCase verb
 */
export declare function isVerb(value: string): value is Verb;
/**
 * Creates a branded Verb type from a string
 * @throws Error if the string is not camelCase
 */
export declare function verb(value: string): Verb;
/**
 * Common CRUD verbs available for all nouns
 */
export declare const CRUD_VERBS: readonly ["create", "read", "update", "delete"];
 ...
 */
export type VerbsFor<Config extends VerbsConfig, N extends keyof Config> = Config[N] extends readonly (infer V)[] ? V : never;
