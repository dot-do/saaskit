 ...
 * ```
 */
export interface AppConfig<Nouns extends readonly string[] = readonly string[], Verbs extends VerbsConfig<Nouns[number]> = VerbsConfig<Nouns[number]>> {
    /**
 ...
 */
export interface ResolvedApp<Nouns extends readonly string[] = readonly string[], Verbs extends VerbsConfig<Nouns[number]> = VerbsConfig<Nouns[number]>> {
 ...
 */
export type App<Nouns extends readonly string[] = readonly string[], Verbs extends VerbsConfig<Nouns[number]> = VerbsConfig<Nouns[number]>> = ResolvedApp<Nouns, Verbs>;
export {};
